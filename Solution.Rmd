...
* The size of the `NYC_stations` is 456 * 19, so there are 456 distinct stations in this dataset.
* 79 stations are ADA compliant
* 9 stations have no vending allow entrance
* 58 stations serve the A train, and among these stations, 17 stations are ADA compliant
